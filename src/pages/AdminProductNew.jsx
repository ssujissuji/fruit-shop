...
function AdminProductNew() {
  ...
  const onSubmit = ({ weightValue, weightUnit, ...rest }) => {
    dispatch(addProduct({ ...rest, weight: `${weightValue}${weightUnit}` }))
    navigate('/')
  }
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            {errors.weightUnit && (
              <p className="mt-1.5 text-xs text-red-500 font-body">{errors.weightUnit.message}</p>
            )}
          </div>
        </div>
